...
UR_APIEXPORT ur_result_t UR_APICALL urEnqueueKernelLaunch(
  ...
  if (isLocalSizeOne && !hKernel->isNDRangeKernel()) {
    ...
    size_t new_num_work_groups_0 = ndr.GlobalSize[0] > numParallelThreads ? numParallelThreads : 1;
    size_t itemsPerThread = ndr.GlobalSize[0] > numParallelThreads ? ndr.GlobalSize[0] / numParallelThreads : ndr.GlobalSize[0];
